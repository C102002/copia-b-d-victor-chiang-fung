...
CREATE SEQUENCE VAH_sec_estados
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_estados(
	idEstado NUMERIC(2) PRIMARY KEY NOT NULL DEFAULT NEXTVAL('VAH_sec_estados'), 
	nombre VARCHAR(40) UNIQUE NOT NULL,
	region VARCHAR(30) NOT NULL
);

CREATE SEQUENCE VAH_sec_ciudades
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_ciudades(
	...
	idCiudad NUMERIC(3) NOT NULL DEFAULT NEXTVAL('VAH_sec_ciudades'),
	nombre VARCHAR(40) NOT NULL,
	CONSTRAINT PK_CIUDAD PRIMARY KEY(idEstado, idCiudad)
);

CREATE SEQUENCE VAH_sec_escuelas
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_escuelas(
	idEscuela NUMERIC(3) NOT NULL DEFAULT NEXTVAL('VAH_sec_escuelas') CONSTRAINT PK_ESCUELA PRIMARY KEY,
...
CREATE SEQUENCE VAH_sec_colores
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_colores(
	idColor NUMERIC(3) NOT NULL DEFAULT NEXTVAL('VAH_sec_colores') CONSTRAINT PK_COLOR PRIMARY KEY,
...
CREATE SEQUENCE VAH_sec_sambas
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_sambas(
	idEscuela NUMERIC(3) NOT NULL CONSTRAINT FK_ESCUELA REFERENCES VAH_escuelas(idEscuela),
	idSamba NUMERIC NOT NULL DEFAULT NEXTVAL('VAH_sec_sambas'),
...
CREATE SEQUENCE VAH_sec_Eventos_Anual_Sem
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_hist_Eventos_Anual_Sem(
	idEscuela NUMERIC(3) NOT NULL CONSTRAINT FK_ESCUELA REFERENCES VAH_escuelas(idEscuela),
	idEvento NUMERIC NOT NULL DEFAULT NEXTVAL('VAH_sec_Eventos_Anual_Sem'),
...
CREATE SEQUENCE VAH_sec_personas_Naturales
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_personas_Naturales( 
	idPersona NUMERIC(8) NOT NULL DEFAULT NEXTVAL('VAH_sec_personas_Naturales') CONSTRAINT PK_PERSONA_NATURAL PRIMARY KEY,
...
CREATE SEQUENCE VAH_sec_personas_Juridicas
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_personas_Juridicas(
	idEmpresa NUMERIC(5) NOT NULL DEFAULT NEXTVAL('VAH_sec_personas_Juridicas') CONSTRAINT PK_PERSONA_JURIDICA PRIMARY KEY,
...
CREATE SEQUENCE VAH_sec_hist_Patrocinios
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_hist_Patrocinios(
	idEscuela NUMERIC(3) NOT NULL CONSTRAINT FK_ESCUELA REFERENCES VAH_escuelas(idEscuela),
	idPatrocinio NUMERIC NOT NULL DEFAULT NEXTVAL('VAH_sec_hist_Patrocinios'),
...
CREATE SEQUENCE VAH_sec_donaciones
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_donaciones(
	...
	idDonacion NUMERIC NOT NULL DEFAULT NEXTVAL('VAH_sec_donaciones'),
...
CREATE SEQUENCE VAH_sec_integrantes
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_integrantes(
	idIntegrante NUMERIC(8) NOT NULL DEFAULT NEXTVAL('VAH_sec_integrantes') CONSTRAINT PK_INTEGRANTE PRIMARY KEY,
...
CREATE TABLE VAH_roles(
	idRol NUMERIC(5) NOT NULL DEFAULT NEXTVAL('VAH_sec_roles') CONSTRAINT PK_ROL PRIMARY KEY,
...
CREATE SEQUENCE VAH_sec_premios_Especiales
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_premios_Especiales(
	idPremioEspecial NUMERIC NOT NULL DEFAULT NEXTVAL('VAH_sec_premios_Especiales') CONSTRAINT PK_PREMIO_ESPECIAL PRIMARY KEY,
	nombre VARCHAR(20) NOT NULL,
...
CREATE SEQUENCE VAH_sec_habilidades
	start with 1
	increment by 1
	maxvalue 99999
	minvalue	1;
...
CREATE TABLE VAH_habilidades(
	idHabilidad NUMERIC(4) NOT NULL DEFAULT NEXTVAL('VAH_sec_habilidades') CONSTRAINT PK_HABILIDAD PRIMARY KEY,
	nombre VARCHAR(20) NOT NULL,
	descripcion VARCHAR(80) NOT NULL
);
...
INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba1', 50, 'NS', '04-02-2022', '04-02-2022', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba2', 50, 'NS', '06-02-2022', '06-02-2022', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba3', 46, 'NS', '02-02-2022', '02-02-2022', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba1', 50, 'NS', '07-02-2022', '07-02-2022', 45, 'Noche de samba en conmemoracion del presidente');

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba', 50, 'NS', '08-02-2022', '08-02-2022', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba', 46, 'NS', '09-02-2022', '09-02-2022', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba1', 50, 'NS', '04-02-2023', '04-02-2023', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba2', 50, 'NS', '06-02-2023', '06-02-2023', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba3', 46, 'NS', '02-02-2023', '02-02-2023', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba1', 50, 'NS', '07-02-2023', '07-02-2023', 45, 'Noche de samba en conmemoracion del presidente');

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba', 50, 'NS', '08-02-2023', '08-02-2023', 45, NULL);

INSERT INTO VAH_hist_Eventos_Anual_Sem(idEscuela,nombre,
costoUnitario,tipoEvento,fechaInicio,fechaFin, totalAsistencias, descripcion)
	VALUES (4, 'Noche de Samba', 46, 'NS', '09-02-2023', '09-02-2023', 45, NULL);
