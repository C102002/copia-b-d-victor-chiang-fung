...
public class RegistrarIntegrante extends JFrame {
	...
	public RegistrarIntegrante() {
		...
		JLabel lbl_RegistrarIntegrante = new JLabel("Registrar Integrante");
		lbl_RegistrarIntegrante.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lbl_RegistrarIntegrante.setBounds(201, 11, 122, 17);
		contentPane.add(lbl_RegistrarIntegrante);
		...
		JButton btnRegistrarIntegrante = new JButton("Registrar Integrante");
		btnRegistrarIntegrante.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if ((!esMenorDeEdad(fechaRevisar) || (esMenorDeEdad(fechaRevisar) && !arrayIdsParientesAConectar.isEmpty())))
				{
					...
					try {
						...
						idIntegrante = sqlController.UpdateQueryReturnCurrentValue("INSERT INTO vah_integrantes(primnom, primap, segap, segnom, apodo, genero, nacionalidad, fechanacimiento, cpf) "
													+ "VALUES ("
													+ primerNombre + "," + primerApellido + "," + segundoApellido + "," + segundoNombre + "," + apodo + ","
													+ genero + ",initcap(" + nacionalidad + ")," + fechaNacimiento + "," + cpf  
													+ ");", "vah_sec_integrantes");
		...
		btnRegistrarIntegrante.setBounds(195, 316, 158, 34);
		contentPane.add(btnRegistrarIntegrante);
